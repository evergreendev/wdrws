...
const ColCard = ({borderClass, textClass, src, header, subHeader, text, items, styles}: props) => {
        ...
        <div className="p-5">
            {items.map(item => {
                return (<Link href={item.url}
                              className="mb-4 hover:bg-secondary-100 transition-colors flex items-center text-gray" key={item.title}>

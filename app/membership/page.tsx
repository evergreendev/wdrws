...
export default async function Page() {
    ...
    return (
        <InnerPageContent width={"MD"} content={
            <div className="py-10">
                <p className="mb-6 text-secondary-500">Prefer paper? <a href="https://cms.wdrws.org/wp-content/uploads/2026/08/WDRWS-2026-Membership-FINAL2-2-1.pdf" target="_blank" rel="noopener noreferrer" className="underline">Print the PDF</a> instead.</p>
                <MembershipForm/>
